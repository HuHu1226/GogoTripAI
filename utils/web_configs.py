...
class WebConfigs:
    ...
    #                               页面配置
    # ==================================================================
    STREET_IMAGE_HEIGHT: int = 400  # 街道图片高度
    EACH_CARD_OFFSET: int = 100  # 每个街道卡片比图片高度多出的距离
    EACH_ROW_COL: int = 1  # 街道页显示多少列
    ...
    #                               街道配置
    # ==================================================================
    STREET_INSTRUCTION_DIR: str = r"./street_info/instructions"
    STREET_IMAGES_DIR: str = r"./street_info/images"

    STREET_INFO_YAML_PATH: str = r"./street_info/street_info.yaml"
    STREET_INFO_YAML_BACKUP_PATH: str = STREET_INFO_YAML_PATH + ".bk"
    ...
    STREET_INSTRUCTION_DIR_GEN_DB_TMP: str = r"./work_dirs/instructions_gen_db_tmp"
